export async function onRequest(context) {
    if (!context.params.domain){
        return new Response(`udpxy参数错误，例：https://iptv.gotonas.com/udpxy_cun/192.168.100.1:4022`);
    }
    const response = await fetch(`https://iptv.gotonas.com/home/udpxy_cun_iptv.m3u8`, {
        method: 'GET',
    });
